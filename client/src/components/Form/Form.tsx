...
export type SelectedFileType = Array<string | ArrayBuffer | FileWithPath>
...
// @ts-ignore
  ...
  const removeFile = (post: PostFormDataInterface, selectedFiles: SelectedFileType) => {
    setPostData({ ...post, selectedFile: selectedFiles })
  }
